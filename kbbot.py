...
class Bot:
    ...
    # type: (State, move) -> bool
        ...
        variable_string = ("pj" + str(index)) or ("pq" + str(index)) or ("pK" + str(index))
    ...
    def calculatePoints(self, state, move):
        ...
        Player1_points = state.get_points(1)
        Player2_points = state.get_points(2)
